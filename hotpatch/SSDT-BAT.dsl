// Battery Status Hotpatch for Lenovo ThinkPad X240.
// Merge Dual Batteries into a single One to have proper reporting on macOS.
// Add SMCD device to Read FAN RPM on HW Monitoring Applications.
